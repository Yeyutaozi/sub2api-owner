...
type Group struct {
	...
	// Independent per-group safe upstream cost multiplier; not tied to sell rate_multiplier
	SafeRateMultiplier float64 `json:"safe_rate_multiplier,omitempty"`
	// 是否启用高峰时段倍率
	...
	// Requested video model -> resolution-specific unit prices
	VideoModelPrices domain.VideoModelPrices `json:"video_model_prices,omitempty"`
	// Video price unit: per_second or per_request; per_request is Seedance-only
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldRateMultiplier, group.FieldSafeRateMultiplier, group.FieldPeakRateMultiplier, group.FieldDailyLimitUsd, group.FieldWeeklyLimitUsd, group.FieldMonthlyLimitUsd, group.FieldImageRateMultiplier, group.FieldImagePrice1k, group.FieldImagePrice2k, group.FieldImagePrice4k, group.FieldBatchImageDiscountMultiplier, group.FieldBatchImageHoldMultiplier, group.FieldVideoRateMultiplier, group.FieldVideoPrice480p, group.FieldVideoPrice720p, group.FieldVideoPrice1080p, group.FieldWebSearchPricePerCall, group.FieldSearchPricePer1k, group.FieldAudioRealtimePricePerMin, group.FieldAudioTtsPricePerMillionChars, group.FieldAudioSttPricePerHour, group.FieldProfitMinMargin, group.FieldProfitSafetyBuffer:
			values[i] = new(sql.NullFloat64)
		case group.FieldID, group.FieldDefaultValidityDays, group.FieldFallbackGroupID, group.FieldFallbackGroupIDOnInvalidRequest, group.FieldSortOrder, group.FieldRpmLimit:
			values[i] = new(sql.NullInt64)
		case group.FieldName, group.FieldDescription, group.FieldPeakStart, group.FieldPeakEnd, group.FieldStatus, group.FieldDuplicateOperationID, group.FieldPlatform, group.FieldSubscriptionType, group.FieldVideoBillingUnit, group.FieldDefaultMappedModel, group.FieldMaxReasoningEffort, group.FieldMaxReasoningEffortOverLimit:
...
func (_m *Group) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case group.FieldSafeRateMultiplier:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field safe_rate_multiplier", values[i])
			} else if value.Valid {
				_m.SafeRateMultiplier = value.Float64
			}
		...
		case group.FieldVideoBillingUnit:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field video_billing_unit", values[i])
			} else if value.Valid {
				_m.VideoBillingUnit = value.String
			}
...
func (_m *Group) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("safe_rate_multiplier=")
	builder.WriteString(fmt.Sprintf("%v", _m.SafeRateMultiplier))
	builder.WriteString(", ")
	...
	builder.WriteString(", ")
	builder.WriteString("video_billing_unit=")
	builder.WriteString(_m.VideoBillingUnit)
	builder.WriteString(", ")
