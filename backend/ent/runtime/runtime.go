...
func init() {
	...
	// groupDescSafeRateMultiplier is the schema descriptor for safe_rate_multiplier field.
	groupDescSafeRateMultiplier := groupFields[3].Descriptor()
	// group.DefaultSafeRateMultiplier holds the default value on creation for the safe_rate_multiplier field.
	group.DefaultSafeRateMultiplier = groupDescSafeRateMultiplier.Default.(float64)
	...
	// groupDescVideoModelPrices is the schema descriptor for video_model_prices field.
	groupDescVideoModelPrices := groupFields[31].Descriptor()
	// group.DefaultVideoModelPrices holds the default value on creation for the video_model_prices field.
	group.DefaultVideoModelPrices = groupDescVideoModelPrices.Default.(domain.VideoModelPrices)
	// groupDescVideoBillingUnit is the schema descriptor for video_billing_unit field.
	groupDescVideoBillingUnit := groupFields[32].Descriptor()
	// group.DefaultVideoBillingUnit holds the default value on creation for the video_billing_unit field.
	group.DefaultVideoBillingUnit = groupDescVideoBillingUnit.Default.(string)
	// group.VideoBillingUnitValidator is a validator for the "video_billing_unit" field. It is called by the builders before save.
	group.VideoBillingUnitValidator = groupDescVideoBillingUnit.Validators[0].(func(string) error)
	...
	// groupDescAllowCreazyCanvas is the schema descriptor for allow_creazy_canvas field.
	groupDescAllowCreazyCanvas := groupFields[50].Descriptor()
	// group.DefaultAllowCreazyCanvas holds the default value on creation for the allow_creazy_canvas field.
	group.DefaultAllowCreazyCanvas = groupDescAllowCreazyCanvas.Default.(bool)
