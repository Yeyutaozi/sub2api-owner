...
func init() {
	...
	groupDescVideoModelPrices := groupFields[30].Descriptor()
	...
	groupDescVideoBillingUnit := groupFields[31].Descriptor()
	...
	groupDescAllowCreazyCanvas := groupFields[43].Descriptor()
