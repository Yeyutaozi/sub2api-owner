...
func groupFromServiceBase(g *service.Group) Group {
	...
	return Group{
		...
		SafeRateMultiplier:              g.SafeRateMultiplier,
...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	return UsageLog{
		...
		AgentAppID:                l.AgentAppID,
		AgentAppVersionID:         l.AgentAppVersionID,
		AgentRunID:                l.AgentRunID,
		AgentNodeID:               l.AgentNodeID,
		AgentNodeRole:             l.AgentNodeRole,
		GroupID:                   l.GroupID,
		...
		VideoTaskStatus:           l.VideoTaskStatus,
		VideoRefundStatus:         l.VideoRefundStatus,
		VideoSettledAt:            l.VideoSettledAt,
		VideoSettlementError:      l.VideoSettlementError,
