...
// RememberSelectedAccount records the current account and completes a pending switch audit.
...
// FlushPendingSwitchAudit writes a pending audit when no target account was selected.
