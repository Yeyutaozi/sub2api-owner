...
func TestMigrationsRunner_IsIdempotent_AndSchemaIsUpToDate(t *testing.T) {
	...
	requireColumn(t, tx, "groups", "video_billing_unit", "character varying", 20, false)
	requireColumnDefaultContains(t, tx, "groups", "video_billing_unit", "per_second")
	requireConstraintDefinitionContains(
		t,
		tx,
		"groups",
		"groups_video_billing_unit_check",
		"video_billing_unit",
		"'per_second'",
		"'per_request'",
	)
