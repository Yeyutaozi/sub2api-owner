...
func registerGroupRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	groups := admin.Group("/groups")
	{
		...
		groups.PUT("/:id/video-price-overrides", h.Admin.Group.BatchSetGroupVideoModelPrices)
		groups.DELETE("/:id/video-price-overrides", h.Admin.Group.ClearGroupVideoModelPrices)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/switch-audit", h.Admin.Account.ListAccountSwitchAudit)
		accounts.GET("/switch-audit/meta", h.Admin.Account.ListAccountSwitchAuditMeta)
		...
		accounts.PUT("/:id/upstream-declared-rate", h.Admin.Account.DeclareUpstreamDeclaredRate)
...
func registerVideoJobRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	...
	{
		videoJobs.GET("", h.Admin.VideoJob.List)
