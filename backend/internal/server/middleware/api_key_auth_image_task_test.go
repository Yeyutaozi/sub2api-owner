...
func TestIsAsyncImageTaskRead(t *testing.T) {
	...
	require.True(t, isAsyncImageTaskRead(http.MethodGet, "/v1/image/tasks/imgtask_123"))
	require.True(t, isAsyncImageTaskRead(http.MethodGet, "/image/tasks/imgtask_123"))
