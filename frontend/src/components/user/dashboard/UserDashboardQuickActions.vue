<template>
  <div class="desk-panel">
    ...
    <div class="space-y-3 p-4">
      <button @click="router.push('/keys')" class="group flex w-full items-center gap-4 rounded-xl border border-accent-200/60 bg-white/70 p-4 text-left transition-all duration-200 hover:border-primary-300/60 hover:bg-primary-50/40 dark:border-dark-600 dark:bg-dark-800/40 dark:hover:bg-dark-800">
      ...
      <button @click="router.push('/usage')" class="group flex w-full items-center gap-4 rounded-xl border border-accent-200/60 bg-white/70 p-4 text-left transition-all duration-200 hover:border-primary-300/60 hover:bg-primary-50/40 dark:border-dark-600 dark:bg-dark-800/40 dark:hover:bg-dark-800">
      ...
      <button v-if="canUseBatchImage" @click="router.push('/batch-image')" class="group flex w-full items-center gap-4 rounded-xl border border-accent-200/60 bg-white/70 p-4 text-left transition-all duration-200 hover:border-primary-300/60 hover:bg-primary-50/40 dark:border-dark-600 dark:bg-dark-800/40 dark:hover:bg-dark-800">
      ...
      <button @click="router.push('/redeem')" class="group flex w-full items-center gap-4 rounded-xl border border-accent-200/60 bg-white/70 p-4 text-left transition-all duration-200 hover:border-primary-300/60 hover:bg-primary-50/40 dark:border-dark-600 dark:bg-dark-800/40 dark:hover:bg-dark-800">
