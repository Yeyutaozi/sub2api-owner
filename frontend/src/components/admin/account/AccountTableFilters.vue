...
const pOpts = computed(() => [{ value: '', label: t('admin.accounts.allPlatforms') }, { value: 'anthropic', label: 'Anthropic' }, { value: 'openai', label: 'OpenAI' }, { value: 'gemini', label: 'Gemini' }, { value: 'antigravity', label: 'Antigravity' }, { value: 'grok', label: 'Grok' }, { value: 'glm', label: 'GLM' }, { value: 'seedance', label: 'Seedance' }, { value: 'ltx', label: 'LTX' }, { value: 'happyhorse', label: 'HappyHorse' }])
