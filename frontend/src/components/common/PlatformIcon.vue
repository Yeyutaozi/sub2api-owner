<template>
  ...
  <!-- GLM / Zhipu connected intelligence mark -->
  <svg v-else-if="platform === 'glm'" :class="sizeClass" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
    ...
    <path stroke-linecap="round" d="m12 5 0 3.75m6.2.05-3.35 1.95m.8 3.65 1.05 3.2m-7.05-3.2-1.1 3.2m.6-6.85L5.8 8.8" />
  </svg>
  <!-- Seedance video mark -->
  <svg v-else-if="platform === 'seedance'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M4 5.5A2.5 2.5 0 0 1 6.5 3h11A2.5 2.5 0 0 1 20 5.5v13a2.5 2.5 0 0 1-2.5 2.5h-11A2.5 2.5 0 0 1 4 18.5v-13Zm6 2.62v7.76a1 1 0 0 0 1.53.85l6.21-3.88a1 1 0 0 0 0-1.7l-6.21-3.88A1 1 0 0 0 10 8.12Z" />
  </svg>
  <!-- LTX video mark -->
  ...
  <!-- MiniMax video mark -->
  <svg v-else-if="platform === 'minimax'" :class="sizeClass" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    <path stroke-linecap="round" stroke-linejoin="round" d="M4 7l4 10 4-7 4 7 4-10M4 19h16" />
  </svg>
<!-- GrokImagine video mark -->
<svg v-else-if="platform === 'grokimagine'" :class="sizeClass" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    <path stroke-linecap="round" stroke-linejoin="round" d="M4 7l4 10 4-7 4 7 4-10M4 19h16" />
  </svg>
