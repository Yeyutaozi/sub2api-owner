    ...
    const requestData = {
      ...
      messages_dispatch_model_config:
        ["openai", "glm"].includes(createForm.platform)
          ...
          : undefined,
      video_model_prices: supportsVideoModelPricingPlatform(createForm.platform)
        ? videoModelPricesPayloadForPlatform(
            createForm.platform,
    ...
    const payload = {
      ...
      messages_dispatch_model_config:
        ["openai", "glm"].includes(editForm.platform)
          ...
          : undefined,
      video_model_prices: supportsVideoModelPricingPlatform(editForm.platform)
        ? videoModelPricesPayloadForPlatform(
            editForm.platform,
            editVideoModelPriceRows.value,
          )
        : serializeVideoModelPrices(editForm.video_model_prices),
      video_billing_unit: normalizeVideoBillingUnitForPlatform(
        editForm.platform,
...
watch(
  ...
  (newVal, oldVal) => {
    ...
    editForm.max_reasoning_effort_over_limit = supportsReasoningEffortPolicyPlatform(
      ...
      ? normalizeReasoningEffortOverLimit(editForm.max_reasoning_effort_over_limit)
      : reasoningEffortOverLimitDowngrade;
    editForm.reasoning_effort_mappings = reasoningEffortMappingsToRows(
