...
const seedancePresetMappings = [
  ...
  { label: 'Weijin FaceRef 480p', from: 'seedance2.0-one-face-reference-480p', to: 'seedance2.0-one-face-reference-480p', color: 'bg-orange-100 text-orange-700 hover:bg-orange-200 dark:bg-orange-900/30 dark:text-orange-400' },
  { label: 'Weijin FaceRef 720p', from: 'seedance2.0-one-face-reference-720p', to: 'seedance2.0-one-face-reference-720p', color: 'bg-yellow-100 text-yellow-700 hover:bg-yellow-200 dark:bg-yellow-900/30 dark:text-yellow-400' },
