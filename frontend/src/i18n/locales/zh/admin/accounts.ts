export default {
    accounts: {
      ...
      schedulerScore: {
        ...
        stickyShort: '粘性',
        ungrouped: '未分组',
        hint: '展示：分组 / 调度分 / 首字(真实请求EWMA) / 倍率 / 错误率 / 粘性分。首字来自近期真实流量，不触发上游探测，仅供参考；分数越高越优先。',
        firstToken: '首字',
        rate: '倍率',
        errorRate: '错误率',
        sticky: '粘性',
        noSample: '暂无样本',
        scorePriority: '分数越高越优先'
      },
      ...
      upstreamBilling: {
        ...
        stale: '已过期',
        unsupported: '不支持',
        newapiSkAuthOrMissingAccess: '探测失败：若你有上游 NewAPI 用户后台，可填个人 Access Token + User ID；否则直接点「填倍率」按供应商告知的成本倍率声明',
        rateNotExposed: '上游 sk 不暴露分组倍率（NewAPI 常态）。有用户后台可填个人 AT+用户ID 自动探测；没有就「填倍率」手动声明',
        manualDeclaredRate: '手动声明上游倍率',
        manualDeclaredRateHint: '当上游（如官方 NewAPI）无法自动探测分组倍率时，请填写与上游一致的成本倍率；未知倍率不会自动切断调度。',
        manualDeclaredRatePlaceholder: '例如 1.0',
        rateSource: '来源：',
        sourceProbe: '自动探测',
        sourceManual: '手动声明',
        badgeProbe: '探测',
        badgeManual: '声明',
        usingManualFallback: '使用手动声明',
        declaredRateValue: '手动声明倍率：{value}x',
        declaredRateHintShort: '调度与安全倍率熔断会使用该声明值。',
        quickDeclare: '填倍率',
        quickDeclareHint: '上游未暴露倍率时，快速写入手动声明倍率',
        quickDeclarePrompt: '请输入上游成本倍率（例如 1.0）',
        probedGroup: '探测分组：{value}',
        newapiAccessHint: '这不是上游整站管理员权限。NewAPI 官方 sk 只返回额度、不返回分组倍率。若供应商给了你 NewAPI「用户登录后台」，在个人设置里复制 Access Token + 自己的用户 ID 即可自动探测该用户可见分组倍率；若你只拿到 sk、没有用户后台，请用「填倍率」按供应商书面/账单倍率手动声明。base_url 可写 https://host/v1。',
        newapiAccessToken: 'NewAPI Access Token',
        newapiAccessTokenHint: '你自己在上游 NewAPI 用户后台/个人中心生成的 Access Token（不是 sk，也不是整站 root 管理员令牌）。需配合下方用户 ID（New-Api-User）。',
        newapiAccessTokenPlaceholder: '用户个人 Access Token',
        newapiUserId: 'NewAPI User ID',
        newapiUserIdHint: '你在上游 NewAPI 的用户数字 ID（请求头 New-Api-User），与个人 Access Token 成对使用；不是管理员专属。',
        newapiUserIdPlaceholder: '例如 1',
        newapiGroup: 'NewAPI 分组名（可选）',
        newapiGroupHint: '该 Key 所属上游分组名；留空则优先使用用户默认分组。',
        newapiGroupPlaceholder: '例如 default / vip',
        newapiUserIdMissing: '缺 NewAPI User ID',
        newapiAccessAuthFailed: 'NewAPI Access Token 鉴权失败',
        newapiAccessFailed: 'NewAPI Access Token 探测失败',
        failed: '失败',
        notProbed: '未探测',
        ...
        safeRateUnknown: '未知',
        overSafeBadge: '超安全倍率',
        overSafeHint: '上游成本倍率高于分组安全倍率，该分组调度将自动切断',
        safeRateCompare: '上游 {upstream}x > 安全倍率 {baseline}x',
      ...
      videoProvider: {
        ...
        lingdongUpstreamModelHint: '未配置映射行时，仅 seedance2.0-one-face-reference-720p 会使用该默认扩展模型。',
        lingdongModelMapping: '请求模型 → 扩展映射模型',
        lingdongModelMappingHint: '只映射列表中的公开请求模型。未列出的模型（如 480p）带视频/音频会被拒绝，避免低价套高价上游。留空映射则默认仅 720p。',
        lingdongModelMappingAdd: '添加映射',
        lingdongModelMappingEmpty: '暂无映射行。默认安全策略：仅 720p 走扩展上游。',
        lingdongModelMappingFromPlaceholder: '请求模型，如 seedance2.0-one-face-reference-720p',
        lingdongModelMappingToPlaceholder: '扩展上游模型，如 sora-v3-pro',
        lingdongModelMappingInvalid: '映射行需同时填写请求模型与扩展模型',
