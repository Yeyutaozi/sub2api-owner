    ...
    settings: {
      ...
      features: {
        ...
        modelPlaza: {
          ...
          enabled: '启用模型广场',
          enabledHint: '开启后侧栏与顶栏显示入口，页面可通过 /model-plaza 独立访问。',
      ...
      security: {
        ...
        sessionBinding: '会话绑定（UA 硬 / IP 软）',
        sessionBindingHint: '将会话与客户端 User-Agent 硬绑定；仅 IP 变化（VPN/代理切换）会软重绑并保持登录，不会强制退出。User-Agent 变化仍会使该会话失效。',
