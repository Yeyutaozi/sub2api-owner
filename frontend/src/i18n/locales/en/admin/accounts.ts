export default {
    accounts: {
      ...
      schedulerScore: {
        ...
        stickyShort: 'Sticky',
        ungrouped: 'Ungrouped',
        hint: 'Shows group / score / first-token (real request EWMA) / rate / error / sticky. TTFT comes from live traffic only (no probes); higher score is preferred.',
        firstToken: 'TTFT',
        rate: 'Rate',
        errorRate: 'Error',
        sticky: 'Sticky',
        noSample: 'No sample',
        scorePriority: 'Higher score is preferred'
      },
      ...
      upstreamBilling: {
        ...
        newapiSkAuthOrMissingAccess: 'Probe failed: if you have a NewAPI user console, fill personal Access Token + User ID; otherwise quick-declare the supplier cost multiplier.',
        rateNotExposed: 'Upstream sk does not expose group ratio (normal for NewAPI). Use personal AT+user id if you have a user console; otherwise quick-declare the supplier rate.',
        manualDeclaredRate: 'Manual upstream rate',
        manualDeclaredRateHint: 'When the upstream (e.g. official NewAPI) cannot expose group ratio automatically, set the cost multiplier to match upstream billing. Unknown rates are never auto-cut.',
        manualDeclaredRatePlaceholder: 'e.g. 1.0',
        rateSource: 'Source:',
        sourceProbe: 'Auto probe',
        sourceManual: 'Manual declare',
        badgeProbe: 'Probe',
        badgeManual: 'Manual',
        usingManualFallback: 'Using manual rate',
        declaredRateValue: 'Declared rate: {value}x',
        declaredRateHintShort: 'Scheduling and safe-rate cut use this declared value.',
        quickDeclare: 'Set rate',
        quickDeclareHint: 'Quick-fill manual declared rate when upstream does not expose ratio',
        quickDeclarePrompt: 'Enter upstream cost multiplier (e.g. 1.0)',
        probedGroup: 'Probed group: {value}',
        newapiAccessHint: 'Not super-admin access. Official NewAPI sk only returns quota, not group ratio. If the supplier gave you a NewAPI user console login, copy your personal Access Token + user id for auto probe; if you only received an sk, use quick declare with the supplier’s cost multiplier. base_url may include /v1.',
        newapiAccessToken: 'NewAPI Access Token',
        newapiAccessTokenHint: 'Your personal Access Token from the upstream NewAPI user console (not the sk, not the site root admin token). Requires New-Api-User.',
        newapiAccessTokenPlaceholder: 'Personal Access Token',
        newapiUserId: 'NewAPI User ID',
        newapiUserIdHint: 'Your numeric NewAPI user id (New-Api-User header), paired with your personal Access Token. Not admin-only.',
        newapiUserIdPlaceholder: 'e.g. 1',
        newapiGroup: 'NewAPI group (optional)',
        newapiGroupHint: 'Upstream group name for this key; leave empty to use the user\'s default group.',
        newapiGroupPlaceholder: 'e.g. default / vip',
        newapiUserIdMissing: 'Missing NewAPI User ID',
        newapiAccessAuthFailed: 'NewAPI Access Token auth failed',
        newapiAccessFailed: 'NewAPI Access Token probe failed',
        failed: 'Failed',
        ...
        safeRateLabel: 'Safe rate:',
        safeRateOk: 'OK',
        safeRateUnknown: 'Unknown',
        overSafeBadge: 'Over safe rate',
        overSafeHint: 'Upstream cost rate exceeds group safe rate; scheduling for over-rate groups is cut',
        safeRateCompare: 'upstream {upstream}x > safe rate {baseline}x',
      ...
      videoProvider: {
        ...
        openvideo: 'OpenVideo Seedance Mini',
        ...
        lingdongUpstreamModelHint: 'When mapping rows are empty, only seedance2.0-one-face-reference-720p uses this default extension model.',
        lingdongModelMapping: 'Request model → extension model',
        lingdongModelMappingHint: 'Only listed public request models are multi-modally mapped. Unlisted models (e.g. 480p) with video/audio are rejected so cheap tiers cannot use expensive upstream. Empty mapping defaults to 720p only.',
        lingdongModelMappingAdd: 'Add mapping',
        lingdongModelMappingEmpty: 'No mapping rows. Safe default: only 720p uses the extension upstream.',
        lingdongModelMappingFromPlaceholder: 'Request model, e.g. seedance2.0-one-face-reference-720p',
        lingdongModelMappingToPlaceholder: 'Extension model, e.g. sora-v3-pro',
        lingdongModelMappingInvalid: 'Each mapping row needs both request model and extension model',
