export default {
    accounts: {
      ...
      upstreamBilling: {
        ...
        rateNotExposed: 'Upstream does not expose rate; set manual declared rate',
        ...
        overSafeHint: 'Upstream cost rate exceeds group sell rate; scheduling for over-rate groups is cut',
        safeRateCompare: 'upstream {upstream}x > sell baseline {baseline}x',
