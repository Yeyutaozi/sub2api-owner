export default {
    ...
    groups: {
      ...
      form: {
        ...
        rateMultiplierLabel: 'Sell Rate Multiplier',
        rateMultiplierHint: 'User-facing sell multiplier (1.0 = standard rate, 0.5 = half price, 2.0 = double). Independent of safe rate.',
        safeRateMultiplierLabel: 'Safe Rate Multiplier',
        safeRateMultiplierHint: 'Independent upstream cost ceiling for this group. Accounts above this safe rate are cut from scheduling. Not tied to sell rate or per-user sell overrides.',
        rpmLimit: 'Requests Per Minute (RPM)',
        rpmLimitPlaceholder: '0 = unlimited',
      ...
      userPricingTitle: 'Per-user Billing',
      userPricingSaved: 'Per-user billing saved',
      addUserRate: 'Add User Rate Multiplier',
      videoPriceOverrides: {
        addUser: 'Add per-user billing',
        optionalRate: 'Rate (advanced, optional)',
        optionalRatePlaceholder: 'Leave empty to keep group rate',
        addAndConfigure: 'Add & configure prices',
        addUserHint: 'Pick a user from the dropdown (do not only paste the email). After adding, the model/resolution price table expands automatically.',
        workflowHint: 'Correct flow: search and select user → Add & configure prices → fill absolute model/resolution prices in the expanded table → Save. Multiplier is optional advanced control, not the main feature.',
        groupDefaultsTitle: 'Group default model prices',
        groupDefaultsEmpty: 'This group has no default model prices yet. You can still set absolute per-user prices, or configure defaults on the group edit page first.',
        configuredUsers: 'Users with billing overrides',
        empty: 'No users have model price (or rate) overrides yet. After adding a user, configure model/resolution prices.',
        column: 'Model prices',
        configure: 'Configure model prices',
        collapse: 'Collapse prices',
        notSetYet: 'Not set',
        overrideCount: '{count} set',
        userTitle: 'Model/resolution prices for {user}',
        ...
        inheritHint: 'Enter an absolute price for each model and resolution. Leave blank to inherit the group price and that model\'s billing unit.',
        fillThenSave: 'Remember to click Save at the bottom-right after filling prices.',
        selectUserFirst: 'Search and select a user from the dropdown first',
        addedConfigureHint: 'User added. Configure model/resolution prices below, then save.',
      ...
      videoPricing: {
        ...
        modelModeHint:
          'Each model inherits the group billing unit unless overridden. Per-second prices multiply by generated duration; per-request prices are charged once per output. A non-empty matrix is also the allowed model list.',
