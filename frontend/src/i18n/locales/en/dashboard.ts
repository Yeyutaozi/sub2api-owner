export default {
  ...
  modelPlaza: {
    ...
    table: {
      ...
      rate: 'Group rate',
      unitPerMillion: 'Unit: $/M',
      unitPerSecond: 'Unit: $/sec',
      unitPerRequest: 'Unit: $/clip',
      perUnitRequest: 'Unit: $/request',
      perUnitImage: 'Unit: $/image',
      perSecond: 'Billed per second',
      perRequest: 'Billed per video clip',
      perImage: 'Per-image billing',
