...
export type Platform = 'anthropic' | 'openai' | 'antigravity' | 'gemini' | 'grok' | 'glm' | 'composite'
...
const BADGE: Record<Platform, string> = {
  ...
  glm: 'bg-indigo-500/10 text-indigo-700 border-indigo-500/30 dark:text-indigo-300',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  glm: 'bg-indigo-500/10 text-indigo-700 dark:bg-indigo-500/10 dark:text-indigo-300',
...
const BORDER_STRONG: Record<Platform, string> = {
  ...
  glm: 'border-indigo-500/35 dark:border-indigo-500/30',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  glm: 'bg-gradient-to-r from-blue-500 to-indigo-600',
...
const TEXT: Record<Platform, string> = {
  ...
  glm: 'text-indigo-700 dark:text-indigo-300',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  glm: 'bg-indigo-100 text-indigo-800 dark:bg-indigo-900/40 dark:text-indigo-300',
...
const GRADIENT: Record<Platform, string> = {
  ...
  glm: 'from-blue-500 to-indigo-600',
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'antigravity' || p === 'gemini' || p === 'grok' || p === 'glm' || p === 'composite'
}
